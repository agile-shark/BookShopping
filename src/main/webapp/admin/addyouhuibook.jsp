...
<html>
  ...
  <tr>
    <td height="40px" bgcolor="#F4FAFB"> <b><font size="+1">酷星书城 管理中心</font> ——<font color="#9CACAF" size="+1">选择要优惠的图书</font></b></td>
  </tr>
  <tr class="ziti">
    <td bgcolor="#F4FAFB" height="40px"> &nbsp;
    <form action="AdminYouhuiCl?type=search" method="post">
    ...
    <input type="submit" name="button2" id="button2" value="搜 索" />
     &nbsp;&nbsp;&nbsp;&nbsp;<font color="#9CACAF">搜索要加入优惠图书的图书类型</font>
     </form>
    </td>
  </tr>
  <tr>
    <td>
    <form action="AdminYouhuiCl?type=addAll" method="post">
    <table width="1136" border="1" cellspacing="0" cellpadding="0" bordercolor="#EEF8F9">
      ...
      <tr  class="ziti">
        <td align="center" height="36px"><input type="submit" name="button" id="button" value="加入优惠图书" /></td>
