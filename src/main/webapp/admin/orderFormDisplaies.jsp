...
ArrayList<String> listValue = (ArrayList<String>)request.getAttribute("orderByNum");
  ...
  <head>
	...
	<script type="text/javascript">
		function jump(){
			...
			if(type == 1){
				myform.action="OrderFormStats?type=1";
			}else if(type == 2){
				myform.action="OrderFormStats?type=2";
			}else if(type == 3){
				myform.action="OrderFormStats?type=3";
			}else if(type == 4){
				myform.action="OrderFormStats?type=4";
			}else if(type == 5){
				myform.action="OrderFormStats?type=5";
			}
			myform.method="post";
			myform.submit();
		}
  ...
  <tr>
    ...
    <div>
  		<center>
  			...
  			strBuf.append("<chart caption='订单成交概况' showNames='1' decimalPrecision='0'>");
  			%>
  			<%
