...
ArrayList<YouHuiBeanNew> al = youhui.getYouhui("tuangou");
int num = youhui.getTuangouPage();
%>
...
<html>
  ...
  <tr>
    <td height="40px" bgcolor="#F4FAFB"> <b><font size="+1">酷星书城 管理中心</font> ——<font color="#9CACAF" size="+1">团购活动列表</font></b>
    <span class="weizhi"><a href="admin/addtuangoubook.jsp"><img src="admin/img/addtuangou.png" style="cursor:pointer;"/></a></span>
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <form action="AdminTuangouCl?type=deleteAll" method="post">
    <table width="1136" border="1" cellspacing="0" cellpadding="0" bordercolor="#EEF8F9">
      <tr class="ziti">
        ...
        <td align="center" bgcolor="#BBDDE5">团购活动名称</td>
      ...
      <%
      	for(int i = 0; i < al.size(); i++) {
      		...
      		<tr class="ziti">
		        ...
		        <td align="center">
		       <a href="admin/edittuangou.jsp?id=<%=yhb.getActivityid() %>"><img src="<%=basePath %>admin/images/imageedit.gif" width="16" height="16" style="cursor:pointer;"/></a>&nbsp;
		        <a href="admin/addtuangoubook.jsp"><img src="<%=basePath %>admin/images/image_(add)6.gif" width="16" height="16" style="cursor:pointer;"/></a>&nbsp;
		        <a href="AdminTuangouCl?type=deleteOne&youhuiid=<%=yhb.getActivityid() %>&bookid=<%=yhb.getBookid() %>">
		        <img src="<%=basePath %>admin/images/imagedelete.gif" width="16" height="16" style="cursor:pointer;" onclick="return window.confirm('是否真的要将此团购商品删除？')" />
		        </a></td>
		      </tr>
      		<%
      	}
