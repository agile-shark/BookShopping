      ...
      <tr>
        <td height="155" colspan="2" align="center" valign="middle"><table width="1137" border="0" cellpadding="0" cellspacing="0" class="tableborder2">
            ...
            <tr>
              ...
              <td width="379" align="left" valign="middle" class="txt2"><%=user.getUsername() %></td>
              <td width="246" align="left" valign="middle" class="txt2">电子邮件地址：</td>
              <td width="290" align="left" valign="middle" class="txt2"><%=user.getUseremail() %></td>
              </tr>
            <tr>
              <td height="34" align="left" valign="middle" class="txt2">详细地址：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getSendaddress() %></td>
              <td align="left" valign="middle" class="txt2">邮政编码：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getUserpostcode() %></td>
              </tr>
            <tr>
              <td height="34" align="left" valign="middle" class="txt2">QQ：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getUserqq() %></td>
              <td align="left" valign="middle" class="txt2">手机：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getUserphone() %></td>
              </tr>
            <tr>
              <td height="34" align="left" valign="middle" class="txt2">标志建筑：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getUserhothouse() %></td>
              <td align="left" valign="middle" class="txt2">最佳送货时间：</td>
              <td align="left" valign="middle" class="txt2"><%=user.getBestsendgoodstime() %></td>
              </tr>
