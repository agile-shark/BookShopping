...
//通过用户的id号来得到用户信息
UserInfo ui = user.getUserById(userid);
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="200" align="center" valign="top"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder">
      <tr>
