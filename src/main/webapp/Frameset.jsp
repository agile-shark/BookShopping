...
<html>
  <head>
    <base href="<%=basePath%>">
    <title></title>
    <link  href="Frameset.css" type="text/css" rel="Stylesheet"/>
...
<div align="center">
 ...
 <div class="f_l"><a href="index.jsp" name="top"><img src = "img/logo.png"></a></div>
 <div class="f_r log">
   <ul>
   <li class="userInfo">
...
<div id="mainNav" class="clearfix">
  <a href="index.jsp" class="cur">酷星首页<span></span></a>
   ...
   <a href="Youhui?activity_type=tuangou">团购图书<span></span></a>
   <a href="Youhui?type=youhui&activity_type=youhui">优惠活动<span></span></a>
...
<div id="search" class="clearfix">
  <form id="searchForm" name="searchForm" method="get" action="top_search"  class="f_r" style="_position:relative; top:5px;">
   ...
   <a href="http://localhost/ecshop/search.php?act=advanced_search"><font size="2px">高级搜索</font></a>
   </form>
</div>
  ...
  <tr>
    <td width="210" height="600">
    <iframe scrolling="no" height="600" width="210" src="LeftMenu.jsp" frameborder="0"></iframe>
    </td>
    <td width="750">
    <iframe  id="right" name="right" src="welcome.jsp" scrolling="yes" height="600" width="750"  frameborder="0"></iframe>
    </td>
  </tr>
  <tr>
    <td height="100" colspan="2">
    <iframe scrolling="no" height="100" width="960" src="footer.jsp" frameborder="0"></iframe>
    </td>
  </tr>
</table>
</div>
